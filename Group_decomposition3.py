...
df_1 = pd.read_csv("recover_Oct.28_0.1_Frb")
rows_1 = df_1["recover_list"].values.tolist()

df_2 = pd.read_csv("recover_Oct.28_0.15_Frb")
rows_2 = df_2["recover_list"].values.tolist()

df_3 = pd.read_csv("recover_Oct.28_0.2_Frb")
rows_3 = df_3["recover_list"].values.tolist()

df_4 = pd.read_csv("recover_Oct.28_0.25_Frb")
rows_4 = df_4["recover_list"].values.tolist()

df_5 = pd.read_csv("recover_Oct.28_0.3_Frb")
rows_5 = df_5["recover_list"].values.tolist()

df_6 = pd.read_csv("recover_Oct.28_0.35_Frb")
rows_6 = df_6["recover_list"].values.tolist()

df_7 = pd.read_csv("recover_Oct.28_0.4_Frb")
rows_7 = df_7["recover_list"].values.tolist()

df_8 = pd.read_csv("recover_Oct.28_0.45_Frb")
rows_8 = df_8["recover_list"].values.tolist()

df_9 = pd.read_csv("recover_Oct.28_0.5_Frb")
rows_9 = df_9["recover_list"].values.tolist()

df_10 = pd.read_csv("recover_Oct.28_0.55_Frb")
rows_10 = df_10["recover_list"].values.tolist()

df_11 = pd.read_csv("recover_Oct.28_0.6_Frb")
rows_11 = df_11["recover_list"].values.tolist()

df_12 = pd.read_csv("recover_Oct.28_0.65_Frb")
rows_12 = df_12["recover_list"].values.tolist()

df_13 = pd.read_csv("recover_Oct.28_0.7_Frb")
rows_13 = df_13["recover_list"].values.tolist()

df_14 = pd.read_csv("recover_Oct.28_0.75_Frb")
rows_14 = df_14["recover_list"].values.tolist()

df_15 = pd.read_csv("recover_Oct.28_0.8_Frb")
rows_15 = df_15["recover_list"].values.tolist()

df_16 = pd.read_csv("recover_Oct.28_0.85_Frb")
rows_16 = df_16["recover_list"].values.tolist()

df_17 = pd.read_csv("recover_Oct.28_0.9_Frb")
rows_17 = df_17["recover_list"].values.tolist()

df_18 = pd.read_csv("recover_Oct.28_0.95_Frb")
rows_18 = df_18["recover_list"].values.tolist()

df_19 = pd.read_csv("recover_Oct.28_1_Frb")
